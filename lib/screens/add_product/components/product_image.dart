...
import 'package:products_image/screens/add_product/components/open_image.dart';
      ...
      child: Align(
        ...
        child: GestureDetector(
          ...
          child: Container(
            ...
            child: CubitBuilder<AddProductCubit, AddProductState>(
              buildWhen: (previosState, state) {
                if (state is ProductAdding ||
                    state is ProductAdded ||
                    state is ProductAddError ||
      ...
      onTap: () => Navigator.push(
        ...
        MaterialPageRoute(
            builder: (context) => CubitProvider.value(
                value: buildContext.read<AddProductCubit>(),
